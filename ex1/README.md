...
```
Στη συνέχεια αντικαταστήσαμε και στις μακροεντολές FOR_LOOP_I και FOR_LOOP_S με *__vectors_x__* όπου ***vectors_x[x][y]***, παίρνοντας έτσι τον τελικό βελτιστοποιημένο κώδικα ***phods_opt.c***.
...
παίρνουμε τώρα το μέσο χρόνο εκτέλεσης της ***phods_motion_estimation()*** για τον βελτιστοποιημένο κώδικα, να είναι **0.003063 sec**.
